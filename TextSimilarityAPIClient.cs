...
namespace APIVerve
{
    public class TextSimilarityAPIClient
    {
        ...
        public TextSimilarityAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public TextSimilarityAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(textsimilarityQueryOptions options)
        {
            try
            {
                if (_isDebug)
